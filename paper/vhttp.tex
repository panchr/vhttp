...
%%%
\newcommand{\AUTHORS}{Rushy Panchal}
\newcommand{\TITLE}{vHTTP: An HTTP Proxy using Vantage-Points}
\newcommand{\KEYWORDS}{http, proxy, vantage points}
...
\tikzstyle{block} = [rectangle, draw, fill=white, text centered, rounded corners, minimum height=2em]
